...
\end{align}
\item For finding value of $MT$ :-
\\
In $\triangle MTS$, Let  $\angle$ TSM = $\phi$, $\angle$ TMS =$\omega$, $\angle$ MTS =$\beta$, Now using sine formula in $\triangle MTS$ we have
\begin{align}
\frac{{\sin \phi}}{MT} = \frac{{\sin\omega}}{ST} = \frac{{\sin \beta}}{SM}
\end{align}
\begin{align}
\frac{{\sin 95.47\degree}}{MT} = \frac{{\sin 60\degree}}{8.14}
\end{align}
\begin{align}
\implies MT=9.35 \label{eq7}
\end{align}
\item For finding coordinates of T:-
\begin{align}
\vec{T}=\vec{M} + \mu m =\mu m  (\because \vec{M}=0) \label{eq3}
\end{align}
Using inner products of vectors in quadrilateral $MIST$,
\begin{align}
\frac{(S-T)^\intercal(S-I)}{\norm{S-T}\times\norm{S-I}}=\cos 120\degree \label{eq4}
\\
\frac{(S-T)^\intercal(M-T)}{\norm{S-T}\times\norm{M-T}}=\cos 60\degree \label{eq5}
\end{align}
\item Now, dividing \eqref{eq4} and \eqref{eq5}, we get:
\begin{align}
\frac{(S-T)^\intercal(S-I)}{(S-T)^\intercal(M-T)} \times \frac{\norm{M-T}}{\norm{S-I}}=\frac{\cos 120\degree}{\cos 60\degree} \label{eq6}
\end{align}
\item On solving \eqref{eq3} and \eqref{eq6} using \eqref{eq7}, we have 
\begin{align}
&\implies \mu=9.35
\\ 
