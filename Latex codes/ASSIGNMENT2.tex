...
\\
\implies \vec{T}= b \times \frac{c^T d}{c^Tb} \times \frac{\cos \gamma} {\cos \beta}\times {\myvec{\cos \beta\\\sin \beta }}
\end{align}
\end{lemma}
\begin{proof}
\begin{itemize}
...
\\
d= b\times \frac{c^T d}{c^Tb} \times \frac{\cos \gamma} {\cos \beta}
\\
\text{which gives }\vec{T}=d \times{\myvec{\cos \beta\\ \sin \beta}}
\end{align}
\end{proof}
