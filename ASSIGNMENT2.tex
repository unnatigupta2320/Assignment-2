...
\end{align}
\begin{align}
\phi=\angle MST= 95.47\degree
\end{align}
\item Now, the polar coordinates of \textbf{T}of $\triangle MTS$ be
\\
\vec{T}=SM\myvec{\cos\phi\\\sin \phi}
\\
\begin{align}
\vec{T}=\myvec{2.78\\7.65}
\end{align}
   \item Now,the Vertices of given Quadrilateral MIST can be written as,
   \begin{align}
 \vec{M}=\myvec{0\\0},\vec{I} = \myvec{3.5\\0}, \vec{S}=\myvec{5.18\\6.27},\vec{T}=\myvec{2.78\\7.65}
 \end{align}
...
\begin{figure}[!ht]
\centering
\includegraphics[ width=\columnwidth, height=12 cm]{MIST Quadilateral.PNG}
