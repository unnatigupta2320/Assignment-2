...
\\
\begin{align}
 \vec{S}=\myvec{SM \cos $\theta$ \\ SM \sin$\theta$}   
\\
\vec{S}=\myvec{8.14\times \cos50.47\\8.14\times \sin50.47}
\\
...
\end{align}
\item Considering the polar coordinates of \textbf{T} of $\triangle MTS$ and solving we get,
\begin{align}
\vec{T}=\myvec{2.42\\9.03}
\end{align}
   \item Now,the Vertices of given Quadrilateral MIST can be written as,
   \begin{align}
 \vec{M}=\myvec{0\\0},\vec{I} = \myvec{3.5\\0}, \vec{S}=\myvec{5.18\\6.27},\vec{T}=\myvec{2.42\\9.03}
 \end{align}
...
\begin{figure}[!ht]
\centering
\includegraphics[ width=\columnwidth, height=10 cm]{qUADRILATERAL mist.png}
