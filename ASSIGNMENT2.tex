...
\\
\implies  75\degree + 105\degree + 120\degree + 60\degree,
\\
\implies 360\degree; 
\\
...
\\
\implies SM^2 = (p-0)^2+(q-0)^2;
\\
$\implies SM^2=p^2+q^2;$
\\
$\implies p^2+q^2=8.14--$ (1)
\\
$And, SI^2=(p-3.5)^2+(q-0)^2;$
\\
$ \implies (p-3.5)^2+q^2 =6.5^2--$(2)
\\
On solving,these two equations we get
\\
(p,q) =(5.46, 6.036)
\\
Similarly we can obtain$,$T as(2.42, 9.03)
\\
Now,On constructing the given  quadrilateral we, get:
